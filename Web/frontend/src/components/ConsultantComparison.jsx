  ...
  const content = loading ? <EmptyState message={t("components.consultantComparison.loading")} icon="bi-hourglass-split" /> : error ? (
    ...
    <div className="space-y-5">
      <section className="rounded-3xl bg-white p-6 shadow-sm">
        <div className="mb-3 flex items-center justify-between gap-3"><h2 className="font-bold text-slate-900">{t("components.consultantComparison.selectConsultants")}</h2><span className="text-xs text-slate-500">{t("components.consultantComparison.maxFour")}</span></div>
