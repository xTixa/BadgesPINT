...
export default function EmailSignatureManager({ Layout, layoutProps = {} }) {
  ...
  return (
    <Layout title={t("consultor.emailSignature.title")} subtitle={t("consultor.emailSignature.subtitle")} {...layoutProps}>
