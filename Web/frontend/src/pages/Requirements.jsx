...
export default function Requirements() {
  ...
  return (
    <div className="min-h-screen bg-[#F2F2F2]">
      {/* Header Section */}
      <div className={`${badge ? getLevelColor(badge.level) : "bg-[#013440]"} text-white py-16 px-6 border-b border-[#2AA4BF]`}>
            ...
            <div>
              ...
              {badge && (
                <div className="flex flex-wrap items-center gap-3 mt-4">
                  <span className="px-4 py-2 rounded-full text-sm font-bold bg-[#2AA4BF] text-[#013440]">
                    {badge.area?.name}
                  </span>
                  <span className="px-4 py-2 rounded-full text-sm font-bold bg-[#F2F2F2] text-[#013440]">
                    {badge.level}
                  </span>
                  <span className="px-4 py-2 rounded-full text-sm font-bold bg-[#F2F2F2] text-[#013440] flex items-center gap-1">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#F2F2F2] border border-[#2AA4BF] rounded-2xl p-6 mb-8">
              <div className="flex items-start gap-4">
                <svg className="w-6 h-6 text-[#013440] flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <div>
                  <h3 className="text-lg font-bold text-[#013440] mb-2">Como conquistar este badge?</h3>
                  <p className="text-[#013440] text-sm">
                ...
                >
                  <div className="flex items-start gap-4 p-6">
                    ...
                    <div className="flex-shrink-0">
                      <div className="w-12 h-12 rounded-full bg-[#013440] text-white flex items-center justify-center font-bold text-lg">
                        {index + 1}
                      </div>
                    </div>
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        <span className="px-3 py-1 rounded-full text-xs font-bold bg-[#013440] text-white">
                          {r.code}
                        </span>
                      </div>
            ...
            {/* Action Card */}
            <div className="bg-[#013440] rounded-2xl p-8 mt-8 text-white text-center border border-[#2AA4BF]">
              ...
              <button className="px-8 py-3 bg-white text-[#013440] rounded-xl font-semibold border border-[#2AA4BF]">
                Submeter Evidências
              </button>
            </div>
          </div>
