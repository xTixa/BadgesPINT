        ...
        <div className="row g-4">
          <div className="col-md-4">
            <div className="card shadow-sm border-0 rounded-4 p-4 text-center">
              ...
              <p className="text-muted">Badges ativos</p>
            </div>
          </div>
          ...
          <div className="col-md-4">
            <div className="card shadow-sm border-0 rounded-4 p-4 text-center">
              ...
              <h4 className="fw-bold">324</h4>
              <p className="text-muted">Utilizadores registados</p>
            </div>
          </div>
          ...
          <div className="col-md-4">
            <div className="card shadow-sm border-0 rounded-4 p-4 text-center">
              ...
              <p className="text-muted">Learning Paths</p>
            </div>
          </div>
        </div>
      </main>
