...
import { getAllBadges, getBadgeDetails, getBadgeImagePng, getBadgesByArea, getPublicBadgeShare } from "../controllers/BadgeController.js";
...
router.get("/badges/:id/image.png", getBadgeImagePng); // versao rasterizada (PNG) da imagem do badge, para clientes sem suporte fiavel a SVG
